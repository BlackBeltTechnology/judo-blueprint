...
The ESM model file (`/model/webshop.model`) is complex XML (XMI) and **must not be modified by hand**. Always use the **Judo Designer** graphical modeling tool to make changes. Direct edits can corrupt the model and lead to unpredictable errors.
