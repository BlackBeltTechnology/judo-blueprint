...
This guide covers integration testing for custom business logic in webshop. It focuses on using the `judo-runtime-core-testkit` to test custom operations, interceptors, and validators.
