...
mutation { create(input: { transferObjectType: {
  container: "{{SERVICE_NAMESPACE}}", name: "{{REQUEST_TO}}"
} }) { success fqn } }
```
...
mutation { create(input: { operation: {
  ...
  operationType: "INSTANCE", binding: "{{SERVICE_NAMESPACE}}::{{REQUEST_TO}}.accept"
} }) { success fqn } }
```
...
mutation { create(input: { operation: {
  ...
  operationType: "INSTANCE", binding: "{{SERVICE_NAMESPACE}}::{{REQUEST_TO}}.reject"
} }) { success fqn } }
```
